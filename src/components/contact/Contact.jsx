              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">info@campusdost.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700"> +91 9990597240</p>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">Flat No. B-204, Tower 3, Orchid Residency</p>
                    <p className="text-gray-700">,Alpha II, Greater Noida, </p>
                    <p className="text-gray-700">Gautam Buddh Nagar, Uttar Pradesh – 201310</p>
                  </div>
                </div>
