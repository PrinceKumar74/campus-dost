  ...
  const features = [
    {
      ...
      description: 'Personalized guidance to help you choose the best-fit college for your aspirations.',
      icon: (
    ...
    },
    {
      ...
      description: 'Expert support with your college applications—from form filling to essay polishing.',
      icon: (
    ...
    },
    {
      ...
      description: 'Preparation strategies and practice resources to help you excel in entrance exams.',
      icon: (
    ...
    },
    {
      ...
      description: 'Support in gathering, organizing, and perfecting your transcripts, certificates, and other documents.',
      icon: (
    ...
    },
    {
      ...
      description: 'Access webinars, guides, and helpful tips—all at no cost to support your college journey.',
      icon: (
    ...
    },
    {
      ...
      description: 'Expert advice to help you discover and apply for scholarships that can ease your financial burden.',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 sm:h-12 md:h-14 lg:h-16 w-10 sm:w-12 md:w-14 lg:w-16 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          {/* Academic Cap Icon */}
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 14l9-5-9-5-9 5 9 5z" />
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 14l6.16-3.422a12.083 12.083 0 01.67 4.342L12 21l-6.83-5.08a12.083 12.083 0 01.67-4.342L12 14z" />
        </svg>
      ),
    },
  ];
      ...
      <div className="w-full max-w-[2000px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-24 3xl:px-32 relative z-10">
        <div className="text-center mb-16 sm:mb-20 md:mb-24">
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto">
            We provide expert admissions support at every step of your academic journey.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10 lg:gap-12 xl:gap-16 mb-16 sm:mb-20 md:mb-24">
          {features.map((feature, index) => (
            <div key={index} className="group bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-500 overflow-hidden p-8 sm:p-10 border border-gray-100 hover:border-blue-100 flex flex-col">
              ...
              <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 mb-4 sm:mb-5 group-hover:text-blue-700 transition-colors duration-300">
                {feature.title}
              </h3>
              <p className="text-gray-600 text-base sm:text-lg mb-6 group-hover:text-gray-700 transition-colors duration-300 flex-grow">
                {feature.description}
              </p>
              <Link
                to="/services"
                className="mt-auto inline-flex items-center text-blue-600 font-medium text-base sm:text-lg group-hover:text-blue-800 transition-colors duration-300"
              >
                Learn more
