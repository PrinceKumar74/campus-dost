...
const ArticlePage = () => {
  ...
  const handleSubscribe = async (e) => {
    ...
    try {
      if (!window.emailjs) {
        await emailjs.init("V8UdzlCNIr0JaZWfs");
      }
      ...
      <div className="relative bg-gradient-to-r  from-blue-400 to-blue-900 py-20 text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            <span className="inline-block bg-yellow-600 text-white text-sm font-bold px-3 py-1 rounded-full mb-4">
              {article.category}
            </span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="space-y-6 sticky top-6">
              {/* Newsletter Signup */}
              <div className="bg-white border border-[#b42638]/20 rounded-xl p-6">
                ...
                <form onSubmit={handleSubscribe} className="space-y-3">
                  <input
                    ...
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-yellow-600 focus:border-blue-900 text-black"
                    required
                  />
                  <button
                    type="submit"
                    disabled={isSubmitting}
                    className={`w-full flex items-center justify-center px-4 py-2 bg-blue-900 hover:bg-yellow-600 text-white font-medium rounded-lg transition-colors duration-300 ${
