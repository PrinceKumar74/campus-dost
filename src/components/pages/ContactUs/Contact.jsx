...
const ContactPage = () => {
  ...
  const courses = [
    ...
    "Certification in Java Full Stack Development",
  ];
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold mb-2 text-white">
            <span className="text-yellow-600">Contact</span> Us
          </h2>
          ...
          <div className="space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-gray-800/80 border border-gray-700 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-yellow-600"
                placeholder="John Doe"
                required
              />
              {errors.name && <p className="mt-1 text-sm text-yellow-600">{errors.name}</p>}
            </div>
            ...
            <div>
              ...
              <input
                ...
                required
              />
              {errors.email && <p className="mt-1 text-sm text-yellow-600">{errors.email}</p>}
            </div>
            ...
            <div>
              ...
              <input
                ...
                required
              />
              {errors.phone && <p className="mt-1 text-sm text-yellow-600">{errors.phone}</p>}
            </div>
            ...
            <div>
              ...
              <select
                ...
                onChange={handleChange}
                className="w-full px-4 py-3 bg-gray-800/80 border border-gray-700 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-yellow-600 appearance-none"
                required
              >
              ...
              {errors.course && <p className="mt-1 text-sm text-yellow-600">{errors.course}</p>}
            </div>
