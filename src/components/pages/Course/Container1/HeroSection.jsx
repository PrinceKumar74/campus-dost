...
const HeroSection = () => {
  ...
  return (
    <section className="relative bg-gradient-to-r from-blue-400 to-blue-900 text-white overflow-hidden">
      {/* Background pattern */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <div className="mb-4">
              <span className="inline-block px-3 py-1 text-sm font-semibold bg-blue-900 rounded-full">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
              ...
              <span className="text-blue-900"> with Campus Dost</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="flex items-center justify-center px-8 py-4 bg-blue-900 hover:bg-yellow-600 text-white font-semibold rounded-lg transition-all duration-300 group" onClick={()=> navigate('/contact')}>
                Register Now
